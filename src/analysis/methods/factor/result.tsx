...
export const buildFactorExportSections = (result: AnalysisResult): AnalysisSection[] => {
  return buildExportSectionsFromResult(result);
};

export const renderFactorResult = (result: AnalysisResult): ReactNode => {
  ...
  return (
    <Stack gap="5">
      {result.sections.map((section) => {
        ...
        const boldValueThreshold =
          section.key === 'pattern' || section.key === 'structure' ? 0.4 : undefined;
